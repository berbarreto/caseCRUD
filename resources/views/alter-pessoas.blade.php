                        ...
                        <div class="col-md-6">              
                            <div class="form-group">
                                ...
                                <input type="text" name="firstName" 
                                       class="form-control" 
                                       value="{{$pessoa->firstName or old('firstName')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="lastName" 
                                       class="form-control" 
                                       value="{{$pessoa->lastName or old('lastName')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" 
                                       class="form-control" 
                                       value="{{$pessoa->email or old('email')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="password" name="password" 
                                       class="form-control" 
                                       value="{{$pessoa->password or old('password')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="gender"                               
                                       class="form-control"
                                       value="{{$pessoa->gender or old('gender')}}"
                                       required>
                            </div>
                        </div>                       
                        <div class="col-md-12">                   
